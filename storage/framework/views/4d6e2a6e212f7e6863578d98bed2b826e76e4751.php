...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('template/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template/plugins/owl.carousel/dist/assets/owl.theme.default.min.css')); ?>">
                    ...
                    <div class="top-menu d-flex align-items-center">
                        <div class="dropdown">
                            <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                                ...
                                <strong><?php echo e(strtoupper(Auth()->user()->name)); ?></strong>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                    <i class="ik ik-power dropdown-icon"></i> <?php echo e(__('Logout')); ?>
...
<?php /**PATH C:\Users\CHATTI\Desktop\emna-laravel\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>